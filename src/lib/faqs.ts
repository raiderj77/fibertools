...
export const toolFaqs: Record<string, FAQ[]> = {
  ...
  "granny-square-planner": [
    ...
    { q: "Can I mix different granny square patterns in one blanket?", a: "Yes, but compare the measured edge lengths and joining requirements before assembly. Different stitch patterns can respond differently even when their nominal round count matches." },
  ],
  "sleeve-calculator": [
