...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description: "Plan your corner-to-corner crochet blanket with exact block counts, diagonal rows, and yardage estimates from your gauge swatch.",
    category: "crochet",
    icon: "🔷",
    tier: 2,
    ready: true,
  ...
  },
  {
    ...
    description: "Calculate exactly how many stitches to cast on for any width, with optional stitch pattern multiple rounding and edge stitch notes.",
    category: "knitting",
    icon: "🧷",
    tier: 2,
    ready: true,
  ...
  },
  {
    ...
    description: "Get cast-on count, crown decrease schedule, and yardage for any head size from preemie to large adult with ease adjustments.",
    category: "both",
    icon: "🧢",
    tier: 2,
    ready: true,
    keywords: ["hat calculator", "knit hat size chart", "crochet beanie calculator", "crown decrease calculator"],
  },
  {
    ...
    tier: 2,
    ready: true,
    keywords: ["sock calculator", "sock knitting calculator", "toe up sock calculator", "heel flap calculator"],
  },
  {
    slug: "granny-square-planner",
    name: "Granny Square Planner",
    shortName: "Granny Planner",
    description: "Plan a granny square blanket with grid layout, total squares, per-color yardage, and joining yarn estimates.",
    category: "crochet",
    icon: "🟩",
    tier: 2,
    ready: true,
  ...
  },
  {
    ...
    description: "Get row-by-row decrease instructions for tapered sleeves in knit or crochet, with evenly distributed shaping.",
    category: "both",
    icon: "💪",
    tier: 2,
    ready: true,
  ...
  },
  {
    ...
    shortName: "Raglan Calculator",
    description: "Calculate neck cast-on, stitch distribution, and increase rounds for a standard top-down raglan sweater.",
    category: "both",
    icon: "👕",
    tier: 2,
    ready: true,
  ...
  },
  {
    ...
    description: "Get the right blocking method for your fiber type, with stretch feasibility ratings and step-by-step instructions.",
    category: "both",
    icon: "📌",
    tier: 2,
    ready: true,
    keywords: ["blocking calculator", "how to block knitting", "blocking guide fiber type"],
  },
  {
