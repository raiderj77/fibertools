...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    description: "Look up entries in the included knitting-needle and crochet-hook size tables; confirm metric diameter and current manufacturer labeling.",
    category: "both",
    icon: "🪡",
    tier: 1,
    ready: true,
  ...
  },
  {
    ...
    description: "Search the included knitting and crochet abbreviations with US/UK references and selected step-by-step notes.",
    category: "both",
    icon: "📖",
    tier: 2,
    ready: true,
  ...
  },
  {
    ...
    description: "Calculate the simplified geometric ratio between entered effective drive-wheel and connected-pulley band-path diameters.",
    category: "spinning",
    icon: "🌀",
    tier: 2,
    ready: true,
  ...
  },
  {
    ...
    description: "Look up 20 archived Anchor-chart pairings for DMC and Anchor codes; compare physical thread and preserve ambiguous results.",
    category: "embroidery",
    icon: "🧵",
    tier: 3,
    ready: true,
  ...
  },
  {
    ...
    description: "Compare measured wraps per inch with overlapping yarn-weight guidance; verify the actual yarn label and swatch.",
    category: "both",
    icon: "📏",
    tier: 2,
    ready: true,
  ...
  },
  {
    ...
    description: "Calculate a rounded cast-on count from width and measured gauge, with an optional whole stitch multiple; add pattern offsets separately.",
    category: "knitting",
    icon: "🧷",
    tier: 2,
    ready: true,
  ...
  },
  {
    ...
    description: "Estimate remaining yarn length from measured remaining weight and the same yarn label; category alone cannot determine yardage.",
    category: "both",
    icon: "🗄️",
    tier: 2,
    ready: true,
