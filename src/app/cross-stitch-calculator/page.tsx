...
export const metadata: Metadata = {
  title: "Cross Stitch Size Calculator",
  description:
    "Calculate finished cross stitch dimensions for any fabric count. Estimate thread amounts per color and fabric size with framing margin.",
  keywords: [
