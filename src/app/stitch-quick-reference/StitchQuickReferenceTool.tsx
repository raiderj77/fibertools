...
const STITCHES: StitchRef[] = [
  ...
  },
  {
    ...
    pullThrus: 1,
    totalSteps: 3,
    tips: "Used for joining rounds and moving yarn without adding height. A joining slip stitch usually does not count; slip-stitch fabric does count these stitches. Follow the pattern.",
    steps: [
