...
export const metadata: Metadata = {
  title: "Weaving Sett & EPI Calculator",
  description:
    "Calculate the right sett (ends per inch) for your yarn and weave structure. Plan warp length with loom waste and shrinkage factored in.",
  keywords: [
