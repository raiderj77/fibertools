...
Each cross stitch on 14-count Aida uses roughly 1.5 inches of floss per stitch when worked with 2 strands, according to [DMC's own yardage guidance](https://www.dmc.com/us/). Bump up to 18-count evenweave and each stitch is physically smaller, so you get more stitches per yard. Drop down to 11-count and each stitch is bigger, so you burn through floss faster. Add a third strand and you're using 50% more thread per stitch. These aren't abstract variables -- they compound.
...
For large projects, the [Stitch Fiddle calculator](https://www.stitchfiddle.com) and [DMC's pattern software](https://www.dmc.com/us/create-a-pattern/) both let you import an image and get a color-by-color stitch count, which makes this math much faster.
