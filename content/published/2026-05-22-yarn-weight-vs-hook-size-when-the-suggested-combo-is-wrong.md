...
A label recommendation is based on how the yarn manufacturer thinks most knitters and crocheters work. A pattern recommendation is based on how one specific designer works. Your tension is yours alone. A label that says "5.0 mm hook" is a starting point, not a finish line. The [Craft Yarn Council's standard weight system](https://www.craftyarncouncil.com/standards/yarn-weight-system) gives hook ranges for each weight category, and those ranges are wide on purpose. A worsted weight yarn, for example, carries a suggested crochet hook range of 5.0 mm to 5.5 mm, but plenty of crocheters work outside that range and get beautiful fabric.
...
Then wash and dry the swatch the same way you'll care for the finished piece. [Some fibers, especially superwash wool and cotton, can grow significantly after washing](https://www.ravelry.com/groups/gauge-is-important). A swatch that measured correctly before washing might be a full hook size too large after.
