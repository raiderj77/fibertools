...
The [Craft Yarn Council's standard yarn weight system](https://www.craftyarncouncil.com/standards/yarn-weight-system) is the reference most US yarn labels follow, so you can cross-check your skein against these categories.
...
2. Measure how many stitches and rows fit in 4 inches (blocking first if the fiber blooms).
3. Weigh your swatch on a kitchen scale in grams.
4. Check the yardage-per-gram on your yarn label (total yards divided by grams per skein).
