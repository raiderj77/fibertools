...
- **Clover Amour** (around $8–$10 per hook): Soft rubber grip, inline head, consistent sizing. The grip is wide enough that most people with hand pain or arthritis report significant relief. [Clover's own size chart](https://www.clover-mfg.com/) shows these run true to metric.
...
The [Craft Yarn Council's standard yarn weight system](https://www.craftyarncouncil.com/standards/yarn-weight-system) gives hook size recommendations per yarn weight:
