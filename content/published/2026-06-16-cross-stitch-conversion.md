...
For example, a common stockinette gauge runs around 5 stitches and 7 rows per inch, which gives you a stitch aspect ratio of roughly 5:7, or about 0.71. That means if you knit a 50-stitch-wide, 50-row-tall chart directly, your finished fabric will be noticeably shorter than it is wide. The [Craft Yarn Council's standard gauge tables](https://www.craftyarncouncil.com/standards/yarn-weight-system) show how much this varies across yarn weights.

To correct for this, you have two options:

1. **Compress the chart horizontally.** Remove roughly every 3rd or 4th column from the original cross stitch chart so the remaining stitches fill a shape that looks proportional in knit fabric. This is tedious but preserves row count.
2. **Scale the chart in software first.** Open the chart image in something like [KG-Chart](https://kg-chart.com/) or [StitchFiddle](https://www.stitchfiddle.com/) and resize it to match your stitch ratio before you start. Enter your actual gauge swatch numbers, not a guess.
...
For color matching, [DMC publishes a conversion chart](https://www.dmc.com/us/color-card.html) that maps thread colors to approximate values, and sites like [Yarnsub](https://yarnsub.com/) let you search yarn by color family. Neither is a perfect science. Hold your yarn skeins up to your printed chart in natural light and make a judgment call.
...
Tapestry crochet, where you carry unused colors across the row and work over them, is the most common technique for converting cross stitch charts. [Craftsy's tapestry crochet overview](https://www.craftsy.com/post/tapestry-crochet/) covers the carry method in detail. The key limitation is that carrying more than 2-3 colors at once gets bulky fast, so simplify your color count before you start.
...
- **[StitchFiddle](https://www.stitchfiddle.com/)** - browser-based, handles both knitting and crochet, free tier is usable
