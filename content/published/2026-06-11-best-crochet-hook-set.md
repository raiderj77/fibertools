...
The [Clover Tunisian set](https://www.clovermfg.com/) includes hooks with removable cables and covers sizes E through K. For larger sizes, ChiaoGoo makes Tunisian hooks in 5.5 mm through 10 mm with flexible cables. If you are just testing Tunisian for the first time, buy one 5 mm or 5.5 mm Tunisian hook before investing in a set.

---

## What should I look for in a hook case or storage?

The case matters more than people think. Hooks stored loose in a bag develop bent tips and scratched shafts, and a scratched shaft will snag yarn. A roll case with individual slots keeps hooks separated. The Clover Amour set comes with a zippered case that works well. If you buy hooks individually, the [Намaste Maker's Bag](https://www.namastemade.com/) and similar roll-style organizers hold mixed sizes without the hooks rattling against each other.
