...
The [Craft Yarn Council's standards page](https://www.craftyarncouncil.com/standards/yarn-weight-system) is the authoritative reference for the numbered weight system. For specific yarns, [Ravelry's yarn database](https://www.ravelry.com/yarns) lets you filter by weight, fiber, and gauge, and shows real project photos knit at different needle sizes. The ball band on your actual skein is your most reliable source for that specific yarn, because fiber content and construction affect gauge even within the same weight category.
